          ...
          <li>
            <Link to="/wishlist" style={{ color: textColor }} className="nav-icon-link">
              ...
              <svg className="nav-icon-svg" viewBox="0 0 24 24" fill="none"
                stroke={textColor} strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
          ...
          <li className="account-nav" style={{ position: "relative" }}>
            ...
            {user && showMenu && (
              <div style={{
                ...
                borderRadius: 6, boxShadow: "0 6px 16px rgba(0,0,0,0.1)"
              }}>
                <button
                  onClick={logout}
                  style={{ background: "none", border: "none", padding: "10px 16px", cursor: "pointer" }}
                >
                  Logout
                </button>
              </div>
