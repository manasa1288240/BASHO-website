    ...
    <footer className="footer-modern">
      <div className="footer-container">
        ...
        <div className="footer-grid">
          ...
          <div className="footer-brand">
            ...
            <div className="social-links">
              ...
              {/* Added Location Link with Pin Icon */}
              <a 
                href={mapUrl} 
                target="_blank" 
                rel="noopener noreferrer" 
          ...
          <div className="footer-column">
            ...
            <div className="footer-content">
              <div className="contact-item">
                <p className="contact-label">Studio Workshop</p>
                {/* Wrapped address in the same coordinate link */}
                <a 
                  href={mapUrl} 
                  target="_blank" 
                  rel="noopener noreferrer"
              ...
              <div className="contact-item">
                <p className="contact-detail">
                  <span className="contact-label">Email:</span> bashobyyshivangi@gmail.com
                </p>
                <p className="contact-detail">
                  <span className="contact-label">Phone:</span> +91 98795 75601
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="footer-column">
            ...
            <ul className="footer-links">
              <li><a href="#journey">Our Story</a></li>
              <li><a href="#workshops">Workshops</a></li>
              <li><a href="#testimonials">Client Tales</a></li>
        ...
        <div className="footer-bottom">
          <p className="copyright">© 2025 Bashō by Shivangi. Handmade with Love.</p>
        </div>
      </div>
    </footer>
  );
